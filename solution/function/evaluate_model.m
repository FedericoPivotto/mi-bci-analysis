...
function evaluate_model(path_model, dirpath_in, filename, fileext, dirpath_out)
    % INFO: path_model: 'solution/model/<filename_with_ext>'
    % INFO: dirpath_in: 'solution/psd/<subject>/', 'solution/psd/population/'
    % INFO: filename: '<filename_without_ext>'
    % INFO: fileext: '.mat'
    % INFO: dirpath_out: 'solution/result/micontinuous/model/' (additional sub-folder according to the different type of plots)
